      ...
      <div class="col m12 s12 offset-m0">
        <div class="card">
          <div class="card-content">
            ...
            <div class="row">
              ...
              <div class="input-field col s12 m6">
                ...
                <p style="cursor: pointer;" @click="open_list_desc">{{getDesc() || 'Выберите задачи'}}</p>
                <br>
              </div>
          ...
          <div class="card-action hide-on-med-and-up">
            <a class="waves-effect waves-blue btn-flat blue-text " @click="save">
              <i class="fa fa-floppy-o"></i>
              </i>
            </a>
            <a class="waves-effect waves-light btn right" @click="openDrive">
          ...
          <div class="card-action hide-on-small-only">
            <a class="waves-effect waves-blue btn-flat blue-text " @click="save">
              <i class="fa fa-floppy-o left"></i>
              </i>Сохранить</a>
            <a class="waves-effect waves-light btn right" @click="openDrive">
              <i class="fa fa-arrow-right right"></i>Поехали</a>
            <a class="waves-effect waves-teal btn-flat left hide" @click="loadInFileds();" id="loadInFileds">Случайные</a>
          </div>
...
var Order = {
  ...
  methods: {
    ...
    select_item_desc(num = null) {
      if (num != null) {
        this.services[num].Select = !this.services[num].Select;
        console.log(this.services[num])
      }
    ...
    $.get(`${urlServer}/order/${this.id}`, (json) => {
      if (json.result == 1) {
        ...
        if (this.order.Descript) {
          ...
          for (let key in this.services) {
            this.$set(this.services[key], 'Select', false)
          }
        }
